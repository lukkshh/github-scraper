    ...
    return (
      <>
        {isLoading ? (
          ...
          <div className="in-w-[570px] max-sm:min-w-[350px] flex items-center justify-center text-white font-bold">
            {Error}
          </div>
        ) : (
          <div className="bg-slate-700 m-2 min-w-[570px] max-sm:min-w-[350px] rounded-3xl overflow-y-scroll flex flex-wrap justify-evenly items-baseline">
            {UserData.map((user) => (
              <div
                key={user.id}
